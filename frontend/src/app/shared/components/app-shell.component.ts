...
import { RagChatComponent } from '../../features/rag/rag-chat.component';
...
@Component({
  ...
  styles: [
    `
      ...
      .chat-window { display: grid; gap: 8px; max-height: 260px; overflow: auto; margin-bottom: 12px; }
      .bubble { background: #0b1428; border: 1px solid #1f2d4a; border-radius: 10px; padding: 10px; }
      .bubble--assistant { border-color: #375a8c; }
      .hint { color: #9cadc8; margin-top: 0; }
